...
##This Document: http://goo.gl/aXkvZm
...
`%>%` operator shortcut:  Ctrl+Shift+M (win) & Cmd+Shift+M (mac)
...
See the full [list of shortcuts](https://support.rstudio.com/hc/en-us/articles/200711853-Keyboard-Shortcuts) in RStudio.
